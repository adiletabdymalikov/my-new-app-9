...
export function Amazon() {
  ...
  useEffect(() => {
    axios.get('https://fakestoreapi.noksha.dev/api/amazonproducts')
      .then((res) => {
...
const handleCheckout = () => {
  ...
  return (
    <div className="container-fluid mt-4">
      <h2 className="text-center fw-bold mb-3">Amazon Store</h2>
      
      <div className="mx-auto mb-4" style={{ maxWidth: '400px' }}>
        <input 
          type="text" className="form-control p-2 text-center" placeholder="Search Amazon product" 
